...
class Gen
{
	...
	{
		return '
		<a class="btn btn-default '.$mCSS.'" onclick="'.$mJS.'" href="#" role="button" id="'.$mID.'"'.($mDismissModal ? ' data-dismiss="modal"' : '').'>
			<span class="glyphicon '.$mIcon.'" aria-hidden="true"></span>
			'.$mText.'
		</a>';
	}

	public static function FC_Textbox($mID, $mPlaceholder, $mType = 'text')
	{
		return ' 
		<div class="form-group">
			<input type="'.$mType.'" id="'.$mID.'" placeholder="'.$mPlaceholder.'" class="form-control">
		</div>';
	}
